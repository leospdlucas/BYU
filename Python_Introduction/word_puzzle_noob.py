...
def game():
    ...
    while again: # Additional Criativity
        word_list = ["WORD", "NOBODY", "ALPHABET", "BOOK", "TABLE", "ANGEL", "BROTHER", "HEART", "ZEBRA", "TIME", "PROBLEM", "BESIDE", "SWIMMING", "TONIGHT", "TOOK", "TREE", "HIERARCHY", "QUEST", "LARGE", "PSYCHOSOCIAL", "GROUP", "HARD", "HIGH", "ALWAYS", "MERMAID", "LIBRARY", "CORD", "EASY", "LOWER", "SYNTHETIC", "NATURE", "INGRAIN","POLYMORPHISM", "HERITAGE", "PATTERN", "DRACONIC", "THRIFT", "SHEET", "SICKNESS", "HYPNOSITY", "SHADOW", "HAMMER", "HUMAN", "PARTICIPANT", "PRODUCTION", "FILTER", "SOMETHING", "NOTHING", "GRAPHIC", "DESCRIPTION", "ACROBATICS"]
